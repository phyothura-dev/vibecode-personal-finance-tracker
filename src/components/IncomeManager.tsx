  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-white p-6 rounded-xl border border-slate-200">
        <div>
          <h3 className="font-semibold text-[#111827] text-lg">{t('incomes.title')}</h3>
          <p className="text-xs text-slate-500 mt-1">{t('incomes.description')}</p>
        </div>
        <button
        ...
        >
          <Plus className="w-4 h-4" /> {t('incomes.addNew')}
        </button>
      </div>
